...
var computePosition=exports.computePosition=function computePosition(layouts){var
...
return(
_react2.default.createElement(_reactNative.Animated.View,_extends({style:[styles.options,style,animation,position]},other,{__source:{fileName:_jsxFileName,lineNumber:59}}),
children));
